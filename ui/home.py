...
class ImageGallery(QWidget):
    ...
    def add_image(self, image_path):
        label = QLabel(self)
        label.setMinimumSize(QSize(64, 180))
        label.setMaximumSize(QSize(64, 180))
        ...
        if not pixmap.isNull():
            scaled_pixmap = pixmap.scaledToHeight(150, mode=Qt.SmoothTransformation)
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.QF_Group.setMinimumSize(QSize(0, 180))
        self.QF_Group.setMaximumSize(QSize(16777215, 180))
        ...
        self.scroll_area = QScrollArea(self.QF_Group)
        scrollbar_style = """
        ...
        self.scroll_area.setMinimumSize(QSize(0, 180))
        self.scroll_area.setMaximumSize(QSize(16777215, 180))
        ...
        self.image_gallery = ImageGallery(self.scroll_area)
        self.scroll_area.setWidget(self.image_gallery)
        ...
        ##图片展示
        # self.scroll_area = QScrollArea(self.QF_Group_cam)
        # self.scroll_area.setWidgetResizable(True)

        # self.image_gallery = ImageGallery()
        # self.scroll_area.setWidget(self.image_gallery)

        # self.horizontalLayout_15.addWidget(self.scroll_area)
    ...
    def retranslateUi(self, MainWindow):
        ...
        # self.image_gallery.add_image('1.jpg')
